...
public class CONSTANT_NameAndType implements CONSTANT_CP_Info {
	...
	byte tag = CONSTANT_NameAndType_info;
	...
	public void writeData(DataOutput out) throws IOException {
		out.write(CONSTANT_NameAndType_info);
	...
	public void readData(DataInput in) throws IOException {
		if(!Settings.cpTagRead) {
			...
			if(tagV != CONSTANT_NameAndType_info) { throw new IllegalStateException("Illegal CONSTANT_NameAndType tag: " + tagV); }
		}
	...
	public String toString() {
		return "CONSTANT_NameAndType(12, name=" + name_index.getCpObject() + ", descriptor=" + descriptor_index.getCpObject() + ")";
	}
