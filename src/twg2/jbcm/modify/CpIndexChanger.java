...
public interface CpIndexChanger {
	...
	public static final CpIndexChanger NO_OP = new CpIndexChanger() {
		@Override public void changeCpIndexIf(byte[] code, int location, int currentIndex, int newIndex) {
		}
	};


	/** Change a constant_pool index if it matches the current target index of the {@code location} instruction.
